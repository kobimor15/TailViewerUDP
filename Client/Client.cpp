...
namespace udp
{
	...
	void Client::recvMessage()
	{
		...
		int n = recvfrom(m_local_socket, reinterpret_cast<char*>(clientBuffer), BUFFER_SIZE, 0, (struct sockaddr*)&m_remote_address, &sizeOfClientAddr);
		clientBuffer[n] = '\0';
		std::cout << "received: " << clientBuffer << "\n";
	}
